...
class CSVParserTest {
    ...
    private String getCsvString() {
        return "Question_01_text;1. Answer_01_text; 1\n" +
                "Question_02_text;1. Answer_01_text,2. Answer_02_text,3. Answer_03_text; 1";
    }

    private List<Question> getExpectedList() {
        var question0 = new Question("Question_01_text", List.of("1. Answer_01_text"), 1);
